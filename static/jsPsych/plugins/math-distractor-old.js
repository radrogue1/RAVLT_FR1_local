jsPsych.plugins['math-distractor'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var num_b = [];
    var num_c = [];
    var tbox = '<input class="task-input" id="math_box" autocomplete="off" spellcheck="false" autofocus></div>'
    var timed_out = false;
    var current_answer;
    var max;
    ...
    var gen_trial = function() {
      ...
      var nums = [randomInt(9), randomInt(9), randomInt(9)];
      ...
      // automatically place cursor in text area when page loads
      // (function(){
      //   ('input').focus();
      // });
    };
